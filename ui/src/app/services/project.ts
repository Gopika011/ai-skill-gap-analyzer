...
export class ProjectService {
  ...
  assignEmployee(projectId: number, data: { employeeId: string }): Observable<void> {
    return this.http.post<void>(`${this.base}/projects/${projectId}/employees`, data);
  }

  removeEmployee(projectId: number, employeeId: string): Observable<void> {
    return this.http.delete<void>(`${this.base}/projects/${projectId}/employees/${employeeId}`);
  }
